...
function updateUI(data) {
    ...
    if (tankNodeEl) {
        ...
        tankNodeEl.querySelector('span:last-child').innerText = tankOnline ? ' SENSOR NODE' : ' SENSOR [OFFLINE]';
    ...
    if (motorNodeEl) {
        ...
        motorNodeEl.querySelector('span:last-child').innerText = motorOnline ? ' CONTROLLER' : ' CTRL [OFFLINE]';
...
async function setMotor(status) {
    ...
    try {
        ...
        alert('System command failed: ' + err.message);
    }
}
